...
function ProjectItem(props) {
  ...
  return (
    <div>
      ...
      <div className="rounded-lg pointer-events-auto relative w-full h-full mt-4">
        <img
          src={project['image']}
          alt="Mockup"
        ...
        />
        <div
          className="transition duration-300 ease-in-out absolute opacity-0 hover:opacity-100  right-0 bottom-0 h-full w-full rounded-lg flex flex-col align-middle content-center justify-center"
