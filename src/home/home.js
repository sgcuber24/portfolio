...
function Home(props) {
  return (
    <div className="h-full lg:w-1/2 flex flex-wrap content-center align-middle bg-black14">
      ...
      <p className="mt-16 text-white text-opacity-50 text-lg">
      ...
      <a href="https://resume.creddle.io/resume/657k02y9xfn" target="_blank">
        <button className="mt-16 text-xl font-bold text-white bg-custom-blue-button  active:bg-blue-700 hover:bg-blue-500 rounded-md w-40 h-10 tracking-wide">
          Résumé
        </button>
      </a>
    </div>
