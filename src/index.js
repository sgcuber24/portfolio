...
class App extends React.Component {
  ...
  render() {
    if (this.state.height <= 450) {
      return (
        <div className="bg-black14 h-screen w-screen flex flex-col flex-wrap justify-center align-middle">
      ...
      return (
        <Router>
          <Switch>
            <>
              <div className="xl:px-32 xl:py-20 px-8 py-6 sm:px-20 sm:py-16 lg:px-24 lg:py-18 bg-black14 h-screen w-screen">
